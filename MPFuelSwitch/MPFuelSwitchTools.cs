...
namespace MaritimePack
{
    public static class Tools
    {
        ...
        public static String PlugInDataPath = AppPath + "GameData/MaritimePack/MPUtils/Plugins/PluginData/";
        ...
        public static List<double> parseDoubles(string stringOfDoubles)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                {
                    Debug.Log("MPtools: invalid float: [len:" + array[i].Length + "] '" + array[i] + "']");
                }
            }
            return list;
        }
