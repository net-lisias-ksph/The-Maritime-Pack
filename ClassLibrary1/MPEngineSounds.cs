...
namespace MaritimePack.engine
{
    ...
    /// </summary>
    public class MPengineSounds : PartModule
    {
        /// <summary>
        ...
        private MaritimePack.engine.MPengineWrapper engine;
        ...
        /// <param name="name">The name of the sound in the game database. No file extensions. e.g. MaritimePack\Sounds\sound_fspropidle</param>
        ...
        public override void OnStart(PartModule.StartState state)
        {
            ...
            engine = new MaritimePack.engine.MPengineWrapper(part);
        ...
        public void FixedUpdate()
    {
        ...
        if (engine != null)
        {
            ...
            if (engine.type == MPengineWrapper.EngineType.FSengine)                 
            {
                maxThrust = engine.maxThrust;
            }
